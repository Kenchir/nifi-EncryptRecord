...
public abstract class AbstractEncryptRecordProcessor  extends  AbstractProcessor{
    static final  public PropertyDescriptor RECORD_READER = new PropertyDescriptor.Builder()
            .name("record-reader")
    ...
    static final public  PropertyDescriptor RECORD_WRITER = new PropertyDescriptor.Builder()
            .name("record-writer")
    ...
    static final public Relationship REL_SUCCESS = new Relationship.Builder()
            .name("success")
            ...
            flowFile = session.write(flowFile, new StreamCallback() {
                ...
                public void process(final InputStream in, final OutputStream out) throws IOException {
                    ...
                    try (final RecordReader reader = readerFactory.createRecordReader(originalAttributes, in, original.getSize(), getLogger())) {
                        ...
                        firstRecord = AbstractEncryptRecordProcessor.this.process(firstRecord, original, context, 1L);
